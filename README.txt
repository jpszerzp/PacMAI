...
• Disclosure: I only used code that affects q5, mainly for purpose of testing (q1 to q5 is officially invented by the faculty of the course at Berkeley). The multiAgent.py file alone satisfies my intention of implementing the targeted adversarial algorithms.
